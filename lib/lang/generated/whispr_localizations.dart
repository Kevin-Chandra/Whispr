...
abstract class WhisprLocalizations {
  WhisprLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());
  ...
  static const LocalizationsDelegate<WhisprLocalizations> delegate = _WhisprLocalizationsDelegate();
...
class _WhisprLocalizationsDelegate extends LocalizationsDelegate<WhisprLocalizations> {
  const _WhisprLocalizationsDelegate();

  @override
  Future<WhisprLocalizations> load(Locale locale) {
    return SynchronousFuture<WhisprLocalizations>(lookupWhisprLocalizations(locale));
  }
...
WhisprLocalizations lookupWhisprLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'en': return WhisprLocalizationsEn();
  }
